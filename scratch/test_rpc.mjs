async function main() {
    ...
    const url = `https://api.etherscan.io/v2/api?chainid=56&module=account&action=txlist&address=${CONTRACT_ADDRESS}&startblock=0&endblock=999999999&sort=asc`;
    console.log("Fetching transactions from Etherscan API V2:", url);
    try {
        ...
        console.error("Error fetching Etherscan V2 API:", err);
    }
}
